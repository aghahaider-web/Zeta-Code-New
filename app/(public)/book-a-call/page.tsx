    ...
    <main style={{ padding: 'var(--space-8) var(--space-5) var(--space-7)' }}>
      <div style={W}>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <button type="submit" disabled={status === 'submitting'} style={{ minHeight: '44px', padding: '0 1.75rem', background: 'var(--color-lime)', color: 'var(--color-ink)', border: 'none', borderRadius: '2px', fontFamily: 'var(--font-body)', fontWeight: 600, fontSize: 'var(--text-sm)', cursor: 'pointer', marginTop: 'var(--space-2)' }}>
