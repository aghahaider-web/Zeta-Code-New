...
export default function BookACallPage() {
  ...
  // ⚡ Bolt: Cache Intl.DateTimeFormat to avoid expensive instantiation in the render loop.
  // toLocaleString creates a new formatter instance every call, which is very slow when mapping over arrays.
