  ...
  return (
    <main style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', background:'var(--color-canvas)' }}>
      <form onSubmit={handleLogin} style={{ width:'100%', maxWidth:400, padding:'2rem' }}>
        ...
        <label htmlFor="email" style={{ display:'block', fontSize:'var(--text-sm)', marginBottom:'0.25rem' }}>Email <span aria-hidden="true" style={{ color: '#B91C1C' }}>*</span></label>
        <input
        ...
        />
        <label htmlFor="password" style={{ display:'block', fontSize:'var(--text-sm)', marginBottom:'0.25rem' }}>Password <span aria-hidden="true" style={{ color: '#B91C1C' }}>*</span></label>
        <input
